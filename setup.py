...
setup(
    ...
    description='Package to support more specific, accurate and timely decision support in operation of safety-critical systems, by combining physics-based modelling with data-driven machine learning and probabilistic uncertainty assessment.',
    long_description='%s\n%s' % (
    ...
    entry_points={
        'console_scripts': [
            'rapid-models = rapid_models.cli:main',
        ]
    },
)
